...
```{r, eval = FALSE}
install.packages('./BernhardtMetabolism.zip', repos = NULL)
```
...
#Reorder the columns
  lotic_site_info_filtered <- info_merged[, c(names(lotic_site_info_full), names(lotic_site_metrics)[names(lotic_site_metrics) != "Site_ID"] )]
