...
A final set of outputs were then exported to the output_data directory of this repository. All files were output as both a .rds and .csv to facilitate use both within R and other environments.
...
```{r Export csv datasets, include = FALSE}
#===============================================================================
